...
/**
    * controller da pagina sobre 
    * @package Sts\controller
    * @subpackage Sobre
    * @version 1.0
    *http://localhost/logistica/app/sts/controller/Sobre.php(caso tente acessar diretamente o arquivo)
    */ 
class Sobre{
    ...
    public function index(){
         ...
         */
      $loadView = new \CORE\ConfigView("sts/view/sobre/sobre", $this->data);
